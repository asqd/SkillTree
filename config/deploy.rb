...
lock "3.8.0"
server '10.10.179.2', roles: [:web, :app, :db], primary: true

set :rvm_ruby_version, '2.3.0@skill-tree'
set :ssh_options, { forward_agent: true, keys: [File.join(ENV["HOME"], ".ssh", "id_rsa")] }

set :application, "rup"
set :repo_url, "git@github.com:PoroshkinaVV/SkillTree.git"
...
set :deploy_to,       '/home/deploy/apps/rup'
...
# set :nginx_domains, "m.kolibri-beauty.ru"
...
namespace :deploy do
  ...
  # task :compile_assets do
    # run_locally "cd #{release_path}; RAILS_ENV=production rake assets:precompile"
  # end
